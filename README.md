...
New signups also trigger a WhatsApp alert (`catalog/whatsapp.py`) to the numbers in
`LEAD_ALERT_WHATSAPP_TO` — via Meta's Cloud API (template `new_lead_alert`) or the
self-hosted whatsmeow bridge as fallback.
